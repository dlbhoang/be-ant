  ...
  <body>
    <div class="container">
      ...
      <div class="body">
        ...
        <p>Gửi ${name},</p>
        <p>Tài khoản quản trị của bạn đã được tạo thành công trên Ant&Create. Chúng tôi rất vui khi có bạn trên tàu!</p>

        <p>Vui lòng đăng nhập vào bảng điều khiển của bạn để bắt đầu hành trình.</p>
        <a class="cta" href="https://fe-ant-create.vercel.app/dashboard/my-profile">Go to Dashboard</a>
